...
<?php include("../head.php"); ?>
	...
	addtags = "t1=<?php echo $_GET['t1']; ?>&t2=<?php echo $_GET['t2']; ?>&t3=<?php echo $_GET['t3']; ?>&id1=<?php echo $_GET['id1']; ?>&id2=<?php echo $_GET['id2']; ?>&id3=<?php echo $_GET['id3']; ?>";
	
	var Config = new Array();
	<?php
		foreach($_SESSION['Planche'] as $conf_id => $tab) {
			$line = 'Config["'. ($conf_id+1) .'"] = new TagConfig("Exam/validtag.php?';
