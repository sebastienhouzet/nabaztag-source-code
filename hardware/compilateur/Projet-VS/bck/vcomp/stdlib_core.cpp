...
"crypt","uncrypt","rfidGetList","rfidRead","rfidWrite","i2cRead","i2cWrite" 	// 7
};
...
OPcrypt,OPuncrypt,OPrfidGetList,OPrfidRead,OPrfidWrite,OPi2cRead,OPi2cWrite,
};
...
"fun[fun[u0]u100 u0]fun[]u100",
 ...
 "fun[S I I I I]I","fun[S I I I I]I","fun[]list S","fun[S I]S","fun[S I S]I","fun[S S S]S","fun[S S S]S"
};
